...
### DV ###
# Local
export DV_UVMA_AXIL_SRC_PATH=${PROJECT_DV_DIR}/uvma_axil/src
export DV_UVME_AXIL_ST_SRC_PATH=${PROJECT_DV_DIR}/uvme_axil_st/src
export DV_UVMT_AXIL_ST_SRC_PATH=${PROJECT_DV_DIR}/uvmt_axil_st/src
